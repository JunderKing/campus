...
class Controller extends BaseController
{
    ...
    public function arrayKeyToLine (Array $array)
    {
        ...
        foreach ($array as $key => $value) {
            ...
            $newArray[$newKey] = is_array($value) ? $this->arrayKeyToLine($value) : $value;
        }
        return $newArray;
    }
    ...
    public static function curlPost($url, $dataArr)
    {
        ...
        //curl_setopt($curlObj, CURLOPT_COOKIEJAR,  $this->cookieFile);
        //curl_setopt($curlObj, CURLOPT_COOKIEFILE, $this->cookieFile);
    ...
    public static function sendTplMsg ($appType, $openId, $formId, $content)
    {
        switch ($appType) {
        case 1:
        ...
        $accessToken = $resArr['access_token'];
        $templateId = 'R4a46YsZrmdpIdcWNIW2P9raouz7DFfGz2ku0ywogAQ';
        $postData = array(
            'touser' => $openId,
