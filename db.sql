...
CREATE TABLE cp_sf_fest_member(
  uid INT UNSIGNED NOT NULL DEFAULT 0 COMMENT 'UserID',
  festid INT UNSIGNED NOT NULL DEFAULT 0 COMMENT '火种节ID',
  is_mentor TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否是导师',
  is_captain TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否是队长',
  ctime TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
CREATE TABLE cp_sf_proj_cmnt(
  ...
  isMentor TINYINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '是否为导师',
...
CREATE TABLE cp_sf_proj_reply(
  ...
  targetid INT UNSIGNED NOT NULL DEFAULT 0 COMMENT '回复ID',
